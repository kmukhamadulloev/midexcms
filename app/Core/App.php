...
use PlainCMS\Admin\Controllers\AuthController;
use PlainCMS\Admin\Controllers\AnalyticsController;
use PlainCMS\Admin\Controllers\BackupController;
use PlainCMS\Admin\Controllers\DashboardController;
use PlainCMS\Admin\Controllers\FormController;
use PlainCMS\Admin\Controllers\MediaController;
use PlainCMS\Admin\Controllers\ModulePlaceholderController;
use PlainCMS\Admin\Controllers\MenuController;
use PlainCMS\Admin\Controllers\PageController;
use PlainCMS\Admin\Controllers\CommentController;
use PlainCMS\Admin\Controllers\SettingsController;
use PlainCMS\Core\Admin\AdminView;
use PlainCMS\Core\Cache\CacheInterface;
use PlainCMS\Core\Cache\FileCache;
use PlainCMS\Core\Cache\NullCache;
use PlainCMS\Core\Theme\ThemeLoader;
use PlainCMS\Core\Theme\ThemeRenderer;
use PlainCMS\Http\Controllers\InstallController;
use PlainCMS\Http\Controllers\InteractionController;
use PlainCMS\Http\Controllers\HomeController;
use PlainCMS\Http\Controllers\PublicPageController;
use PlainCMS\Http\Controllers\SeoController;
use PlainCMS\Http\Controllers\ThemeAssetController;
use PlainCMS\Http\Controllers\UploadAssetController;
use PlainCMS\Modules\Analytics\AnalyticsRepository;
use PlainCMS\Modules\Analytics\AnalyticsService;
use PlainCMS\Modules\Backups\BackupService;
use PlainCMS\Modules\Comments\CommentRepository;
use PlainCMS\Modules\Comments\CommentService;
use PlainCMS\Modules\Forms\FormRepository;
use PlainCMS\Modules\Forms\FormService;
use PlainCMS\Modules\Likes\LikeRepository;
use PlainCMS\Modules\Likes\LikeService;
use PlainCMS\Modules\Media\MediaRepository;
use PlainCMS\Modules\Media\MediaService;
use PlainCMS\Modules\Menus\MenuRepository;
use PlainCMS\Modules\Menus\MenuService;
use PlainCMS\Modules\Pages\ContentRenderer;
use PlainCMS\Modules\Pages\PagePreviewSigner;
...
final class App
{
    ...
    public function __construct(
        ...
        $this->session = new Session((string) $this->config->get('security.session_name', 'plaincms_session'));
